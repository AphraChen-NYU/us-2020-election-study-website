  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#14213d]/10 bg-[#f7f4ed]/95 backdrop-blur">
      <div className="mx-auto flex min-h-20 max-w-[1440px] items-center justify-between gap-5 px-5 sm:px-8 lg:px-12">
        <Link href="/" className="group flex items-center gap-3" aria-label="U.S. 2020 Election Study home">
          ...
          <span className="max-w-[220px] text-sm font-semibold leading-tight tracking-[-0.01em] text-[#14213d] sm:text-base">
        ...
        <button
          ...
          className="grid size-11 place-items-center rounded-full border border-[#14213d]/20 text-[#14213d] lg:hidden"
        >
      ...
      {open ? (
        <nav id="mobile-navigation" aria-label="Mobile navigation" className="border-t border-[#14213d]/10 px-5 py-4 lg:hidden">
